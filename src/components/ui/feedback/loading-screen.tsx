...
import { BeautyContainer } from '@/components/ui'
import { FC } from 'react'

export const LoadingScreen: FC = () => {
  const theme = useTheme()

  const green = (theme?.colors as any)?.blue ?? {}

  return (
    <>
      <BeautyContainer className="relative flex h-full w-full items-center justify-center overflow-hidden">
        <div className="boxes">
          <div className="box">
            <div />
            <div />
