        ...
        <LinkWrapper
          ...
          className={cn(
            item.current || areSomeChildrenCurrent
              ...
              : 'text-secondary-foreground hover:bg-primary-foreground hover:text-primary',
            'group flex w-full justify-between rounded-md p-2 text-sm font-semibold leading-6 hover:no-underline focus:bg-primary-foreground focus:text-primary',
          )}
        >
...
export const Sidebar = React.forwardRef<SidebarRefType, SidebarProps>(
  (
    ...
    const { onOpen, isOpen, onClose } = modal
